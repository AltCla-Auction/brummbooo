...
export const metadata: Metadata = {
  ...
  description:
    '社会貢献活動を行う任意団体 Brumm Booo Driving Society。子どもの体に合った安全な車のシートづくりを広げ、チャイルドシート、ジュニアシート、後席シートベルトを親子で見直すきっかけを届けます。',
  keywords: [
    'チャイルドシート',
    'ジュニアシート',
    '後席シートベルト',
  ...
  twitter: {
    ...
    title: '子どものセーフコクピット・プロジェクト｜Brumm Booo Driving Society',
    description:
      '社会貢献活動を行う任意団体 Brumm Booo Driving Society。子どもの体に合った安全な車のシートづくりを広げます。',
