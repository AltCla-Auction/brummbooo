...
親子のドライブがより安全で楽しい時間になるよう、正しい情報の周知と見直しのきっかけづくりに賛同しています。`,
  },
  {
    ...
    sortLast: true,
    message: `Brumm Booo Driving Society の事務局であるオールコンパス株式会社が運営するオルクラは、クルマを楽しみ、大切に乗り続ける文化を広げるサービスです。同乗する子どもの安全な車のシートづくりは、その延長にある大切なテーマ——「子どものセーフコクピット・プロジェクト」に賛同し、正しい情報の周知と家庭での見直しのきっかけづくりに協力しています。`,
  },
  {
